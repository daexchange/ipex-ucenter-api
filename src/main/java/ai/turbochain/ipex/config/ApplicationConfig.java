    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(new MemberInterceptor())
                ...
                .excludePathPatterns("/register/**", "/mobile/code", "/email/code","/email/login/code","/email/reset/code","/getKaptchaImage","/login","/check","/check/login","/start/captcha","/support/country",
                        "/ancillary/**","/announcement/**","/mobile/reset/code","/reset/email/code","/mobile-register/email","/mobile-exange/asset/wallet/**","/mobile-exange/asset/quick-pay","/reset/login/password","/vote/info","/coin/supported","/financial/items/**","/coin/guess/index","/coin/guess/record"
