...
import ai.turbochain.ipex.exception.GeeTestException;
...
public class GeeTestAspect {
    ...
    @Pointcut("execution(public * ai.turbochain.ipex.controller.RegisterController.registerByEmail(..))"+
            "||execution(public * ai.turbochain.ipex.controller.SmsController.resetPasswordCode(..))"+
            "||execution(public * ai.turbochain.ipex.controller.RegisterController.sendResetPasswordCode(..))")
    public void geeTest() {
    }
    @Pointcut("execution(public * ai.turbochain.ipex.controller.SmsController.sendCheckCode(..))")
