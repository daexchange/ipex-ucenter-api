...
public class AntiAttackAspect {
     ...
     */
    @Pointcut("execution(public * ai.turbochain.ipex.controller.RegisterController.sendBindEmail(..))" +
            "||execution(public * ai.turbochain.ipex.controller.RegisterController.sendAddAddress(..))" +
            "||execution(public * ai.turbochain.ipex.controller.SmsController.sendResetTransactionCode(..))" +
            "||execution(public * ai.turbochain.ipex.controller.SmsController.setBindPhoneCode(..))" +
            "||execution(public * ai.turbochain.ipex.controller.SmsController.updatePasswordCode(..))" +
            "||execution(public * ai.turbochain.ipex.controller.SmsController.addAddressCode(..))" +
            "||execution(public * ai.turbochain.ipex.controller.SmsController.resetPhoneCode(..))")
